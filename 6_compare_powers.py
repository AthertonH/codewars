...
# Only positive integers will be tested, incluing bigger numbers - you are warned now, so be diligent try to implement
# an efficient solution not to drain too much on CW resources ;)!

# def compare_powers(n1, n2):
#     if n1[0] > 0 and n1[1] > 0 and n2[0] > 0 and n2[1] > 0:
#         number1 = (int(n1[0]) ** int(n1[1]))
#         number2 = (int(n2[0]) ** int(n2[1]))
#         if number1 > number2:
#             return -1
